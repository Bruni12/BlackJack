...
#Point Counter
pointcounter = Frame(root, bg = background_color, **hightlight_frame_with_white)
pointcounter.pack(side = LEFT, fill = Y)

dealer_point = Frame(pointcounter,bg = background_color)
dealer_point.pack(side = TOP, fill = BOTH)

player_point = Frame(pointcounter,bg = background_color)
player_point.pack(side = BOTTOM, fill = BOTH)


player_point_label = Label(player_point, bg = background_color, text = 'Player Point: ', **button_args)
player_point_label.pack()

dealer_point_label = Label(dealer_point, bg = background_color, text = "Dealer Point: ", **button_args)
dealer_point_label.pack()
#Point Counter END
